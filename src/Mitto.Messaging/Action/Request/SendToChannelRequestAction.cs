...
namespace Mitto.Messaging.Action.Request {
	public class SendToChannelRequestAction : RequestAction<ISendToChannelRequest, ACKResponse> {
		public SendToChannelRequestAction(IClient pClient, ISendToChannelRequest pMessage) : base(pClient, pMessage) { }
